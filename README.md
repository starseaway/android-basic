...
这是一个精简的 Android 基础模块库，不包含具体业务逻辑，主要对常用的基类、管理类、工具类等相关开发能力做了一层封装。
...
```groovy
implementation 'com.github.starseaway:android-basic:2.4.0'
```
...
### V2.4.0 (2026-09-12)
- ✨ feat: 新增 Fragment 预加载机制，优化首次页面切换性能。
