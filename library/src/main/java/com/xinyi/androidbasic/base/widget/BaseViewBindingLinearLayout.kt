...
/**
 * BaseLinearLayout 的 ViewBinding 基类
 *
 * @author 新一
 * @date 2024/10/8 9:52
 */
abstract class BaseViewBindingLinearLayout<VDB : ViewDataBinding> @JvmOverloads constructor(
    context: Context,
    attributeSet: AttributeSet? = null,
    defStyleAttr: Int = 0
) : BaseLinearLayout(context, attributeSet, defStyleAttr),
    Handler.Callback,
    ActivityAction,
    ThreadHandlerProxy {
